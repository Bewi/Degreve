(function() {
    ...
    function configBlock($stateProvider) {
        $stateProvider.state('invoices', {
            ...
            url: '/delivery-notes?orderBy&orderByDirection&page&pageSize&back&search&customerId',
            templateUrl: 'app/invoices/invoices.html',
            controller: 'InvoicesController',
            controllerAs: 'vm',
            params: {
            ...
            resolve: { invoicesPrep: deliveryNotesPrepService }
    ...
    /* @NgInject */  
    function deliveryNotesPrepService(InvoicesResource, $stateParams) {
        $stateParams.postponed = true;
        return InvoicesResource.query($stateParams).$promise;
    }
