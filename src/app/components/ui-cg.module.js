 ...
 * @param {function=} ngChange Assignable angular function that will be called on input change.
 * @param {string=} ni-class The class to give to the input element (default: none).
 *
 * @example
 <example module="app">
 <file name="index.html">
    <div ng-controller="NumberInputCtrl">
        <numberinput ng-model="value" decimals="2" decimal-separator=","
			...
			ng-change="valueChanged()" ni-class="red"/>
    ...
    return {
        ...
        link: function (scope, element, attrs, ctrls) {
            ...
            function render() {
                ...
                if (decimals > 0)
                    viewValue = modelValue.toFixed(decimals).replace('.', decimalSeparator);
...
angular.module("template/numberinput/numberinput.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/numberinput/numberinput.html",
    ...
    "    <input type=\"text\" class=\"input-mini {{niClass}}\" type=\"text\" ng-model=\"number\" float ng-disabled=\"disabled\" ng-change=\"change\">\n" +
    "    <span class=\"btn-group\" ng-if=\"spinner\">\n" +
